...
void init_position(){
  int posi1[8] = { limit[0][0], limit[1][1], limit[2][1], limit[3][0],
                   limit[4][1], limit[5][1], limit[6][1], limit[7][1] };
  spider.move_arr(posi1, speed + 10000);

  delay(500);
  
  int posi2[8] = { spider[0].read(), spider[1].read(), spider[2].read(), spider[3].read(), 
                  (limit[4][0]+limit[4][1])/2,  (limit[5][0]+limit[5][1])/2,  (limit[6][0]+limit[6][1])/2,  (limit[7][0]+limit[7][1])/2 };
  spider.move_arr(posi2, speed + 13000);
  
  int posi3[8] = {(limit[0][0]+limit[0][1])/2,  (limit[1][0]+limit[1][1])/2,  (limit[2][0]+limit[2][1])/2,  (limit[3][0]+limit[3][1])/2,
                   spider[4].read(), spider[5].read(), spider[6].read(), spider[7].read() };
  spider.move_arr(posi3, speed + 10000);
}

void init_pos2(){
  int posi[8] = { (limit[0][0]+limit[0][1])/2,  (limit[1][0]+limit[1][1])/2,  (limit[2][0]+limit[2][1])/2,  (limit[3][0]+limit[3][1])/2,
                  (limit[4][0]+limit[4][1])/2,  (limit[5][0]+limit[5][1])/2,  (limit[6][0]+limit[6][1])/2,  (limit[7][0]+limit[7][1])/2 };
  spider.move_arr(posi, speed);
}
...
void anticlock(){
  int posi1[8]={ limit[0][1],  spider[1].read(),  limit[2][0],  spider[3].read(),
                 limit[4][1],  limit[5][1]-20,   limit[6][1],  limit[7][1]-20 };
  spider.move_arr(posi1, speed);
  ...
  int posi3[8]={ spider[0].read(),  limit[1][1],  spider[2].read(), limit[3][0],
                 limit[4][1]+20,   limit[5][1],  limit[6][1]+20,  limit[7][1] };
  spider.move_arr(posi3, speed);
...
void clock(){
  int posi1[8]={ limit[0][0],  spider[1].read(),  limit[2][1],  spider[3].read(),
                 limit[4][1],  limit[5][1]-20,   limit[6][1],  limit[7][1]-20 };
  spider.move_arr(posi1, speed);
  ...
  int posi3[8]={ spider[0].read(),  limit[1][0],  spider[2].read(), limit[3][1],
                 limit[4][1]+20,   limit[5][1],  limit[6][1]+20,  limit[7][1] };
  spider.move_arr(posi3, speed);
...
void (*fp[7])() = {init_position, walk, squat, anticlock, hello, clock, swim};
